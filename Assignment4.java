...
public class FinalAssignment {
    ...
    public static void main(String[] args) {
        ...
        double largest = -999999;//variable to keep trak of which balance is going the be the largest
        ...
        try {//beginning of actual algorithm
            ...
            while (fh.hasNext()){//while the scanner is scanner the file and there is more to scan this loop will continue scanning those lines
                ...
                String u = tokens[0];//tokesn[0] is the first bit of text which is the account number, it gets assigned to u
                ...
                double z = Double.parseDouble(tokens[3]);//turned into a double this is the  payment the cumstomer made
                System.out.printf(" Your most recent payment: %.2f \n", z);//pints the variable z
        ...
        System.out.printf("There were %s customers \n", tally);//after all the customer's final balance it calculated this will print how many customers there were
